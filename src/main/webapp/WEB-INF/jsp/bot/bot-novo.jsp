			...
			<div class="row">
				...
				<div class="col-8 text-white bg-dark shadow-sm">
					<h2 class="text-center">
						<strong>Nova configuração do bot</strong>
					</h2>
					<form:form modelAttribute="botModel" action="${contextPath}/bot"
						...
						<div class="form-group">
							<label class="control-label" for="nome">Mensagem de boas
								vindas:</label>
							<form:input type="text" path="welcome_msg" name="welcome_msg"
								id="welcome_msg" class="form-control" maxlength="50" size="50" />
						...
						<div class="form-group">
							<label class="control-label" for="farewell_msg">Mensagem
								de despedida:</label>
							<form:input type="text" path="farewell_msg" name="farewell_msg"
								id="farewell_msg" class="form-control" maxlength="50" size="50" />
						...
						<div class="form-group">
							<label class="control-label" for="default_answer">Resposta
								default:</label>
							<form:input type="text" id="default_answer" path="default_answer"
								name="default_answer" class="form-control" />
